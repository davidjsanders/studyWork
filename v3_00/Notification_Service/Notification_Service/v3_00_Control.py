...
#    redis = {'host':'localhost', 'port':6379, 'db':0}
    ...
    def __init__(self):
        ...
        self.Notification_Service_db = Notification_Service_Database(
    ...
    def fetch_notifications(
        ...
        return self.Notification_Service_db.get_notifications(recipient)
    ...
    def clear_notification(
        ...
        return self.Notification_Service_db.clear_notification(identifier)
