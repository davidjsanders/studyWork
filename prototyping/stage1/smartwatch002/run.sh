...
docker run -p $portToUse:5000 -P \
    --name smartwatch002 \
    -v /home/dasander/studyWork/prototyping/stage1/smartwatch002/datavol:/datavol \
    -d dsanders/smartwatch002 /bin/bash \
    -c /phonews/startup.sh
