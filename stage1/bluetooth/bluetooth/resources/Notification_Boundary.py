...
from bluetooth.resources.Notification_DB import Notification_DB
#from bluetooth.resources.Config import __is_locked
...
class Notification_All(Resource):
    ...
    def get(self, controlkey=None):
        try:
            ...
            if return_list == []:
                return_message = 'No bluetooth.'
            else:
                return_message = 'bluetooth found'
        except exceptions.ValidationError as ve:
