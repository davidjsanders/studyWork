...
class Subscribe_Boundary(Resource):
    def get(self):
        return subscribe_control_object.sample_request()
    ...
    def put(self):
        ...
        # then return.
        #
        return_state = subscribe_control_object.not_implemented('PUT')
        # Return
        return return_state
    ...
    def delete(self):
        ...
        # then return.
        #
        return_state = subscribe_control_object.not_implemented('DELETE')
        # Return
        return return_state
