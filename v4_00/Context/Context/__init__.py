"""
    Context:      __init__.py
    Overivew:    The initialization context of the package notes.
    Purpose:     Define the app and api variables.
                 Import the main.py main context.
...
"""
# Import the context Flask from the flask package
