"""
    ...
    Date:        26 Jan 2016
    ------------------------------------------------------------------------
    Overivew:    The Monitor_App application models a Monitor_App handsfree 
    ...
    App Structure
    -------------
    /Monitor_App                     - Root directory.
       runserver.py                - this file.
       startup.sh                  - the startup command when containerized.
     * Monitor_App_uwsgi.ini         - UWSGI ini file - only in container.
     * Monitor_App_uwsgi.conf        - UWSGI config file - only in container.
     - /bin                        - start, stop, & build - NOT in container.
       /Monitor_App                  - Package root.
       ...
       /Monitor_App_Boundary         - The boundary interfaces.
