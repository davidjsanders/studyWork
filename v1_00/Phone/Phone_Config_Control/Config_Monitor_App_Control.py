...
class Config_Monitor_App_Control(object):
    ...
    def is_launched(self):
        ...
        try:
            self.__controller.log('Request to check Monitor App state.',
                                  screen=False)
            state = 'connected'
            ...
            self.__controller.log('Monitor App state returned as:{0}'\
                                      .format(data),
                                  screen=False)
    ...
    def start(self, json_string=None):
        ...
        try:
            ...
            self.__controller.log('Request to start Monitor App',
                                  screen=False)

            json_data = json.loads(json_string)

            self.__controller.log('Getting JSON data',
                                  screen=False)
            key = json_data['key']
            ...
            self.__controller.log('Calculating recipient and location provider',
                                  screen=False)
            ...
            self.__controller.log('Set recipient to {0}'.format(recipient),
                                  screen=False)
            ...
            self.__controller.log('Set location provider to {0}'\
                                      .format(location_provider),
                                  screen=False)

            self.__controller.log('Setting Monitor App URL',
                                  screen=False)

            monitor_app_url = monitor_app + '/state/on'

            self.__controller.log('Monitor App URL set to {0}'\
            ...
            self.__controller.log('Submitting Monitor App start to {0} '\
                                  .format(monitor_app_url)+\
            ...
            self.__controller.log('Monitor App request returned status: {0} '\
                                  .format(status_code),
                                  screen=False
                                 )
            ...
            if status_code not in (200,201):
                ...
                data = {'state':'connected',
                        'monitor-app':monitor_app}
                self.__controller.log('Monitor App returned: {0} '\
                                          .format(data),
                                      screen=False
                                     )
    ...
    def stop(self, json_string=None):
        ...
        try:
            self.__controller.log('Request to sop Monitor App',
                                  screen=False)
            ...
            self.__controller.log('Getting the current Monitor App config.',
                                  screen=False)
            ...
            self.__controller.log('Monitor App currently on {0}'\
                                      .format(monitor_app),
                                  screen=False)
            ...
            self.__controller.log('Submitting Monitor App stop to {0} '\
                                  .format(monitor_app_url)+\
                                  'with payload {0}'.format(payload),
                                  screen=False
                                 )
